  ...
  useEffect(() => {
    const initializeData = async () => {
      try {
        ...
        // Only initialize with static data if we have no data at all
        // and this is likely the first time setup
        if (teamMembers.length === 0 && events.length === 0) {
